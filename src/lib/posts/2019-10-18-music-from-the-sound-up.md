...
titleistitle: 1
header: 
  url: 'sound-up-header.jpg'
  altText: 'Exhibition panels with titles "waves", "light", "sieve", and "taste"'
  credit: ''
gallery:
  location: 'exhibitions/sound-up/'
short: 'Purpose: Presenting and exploring six fundamental concepts in audio synthesis to provide visitors with a functional understanding of how synthesizers create sound.'
---
...
Check out the [GitHub repository](https://github.com/jonathanpiper/SYNTHSPEX) for the Python code used for the exhibition. The PureData synth engine was written by [Dr. Chris Warren](https://music.sdsu.edu/index.php/faculty/chris_warren).
